        ...
        <div className="flip-card">
            <div className="flip-card-inner">
                <div className="flip-card-front">
                    ...
                    <img className="poke-img" src={pokemon.sprites.other.dream_world.front_default} alt='Pokemon' />
                    <ul className="type-list">{pokeTypes}</ul>
                </div>
                <div className="flip-card-back">
                    <h2 className="flip-card-title" >{pokemon.name.toUpperCase()}</h2>
                    <img className="poke-img" src={pokemon.sprites.front_default} alt='Pokemon' />
